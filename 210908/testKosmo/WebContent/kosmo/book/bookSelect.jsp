...
<script type="text/javascript">
	...
	function memUpdate(actionUpdate){
		console.log("memUpdate 진입 >>> : " + memUpdate);
	...
	function checkAction(actionName){
		...
		if ('I' == actionName){	
			location.href="/testKosmo/book/book.html";
		}
		if ('SALL' == actionName){			
...
<font size="4" color="blue">
	<img src="/testBook/img/ase.gif" width="25" height="25" alter="image">
	BOOK TEST
</font>
</td>
</tr>
...
<form name="bookUpdateForm" id="memUpdateForm">
<table border=1>
<tr>
