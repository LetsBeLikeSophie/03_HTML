...
//	 수정함 각 값만 보이게 어짜피 cvo 안에 있음 다른 회원은 다른 CsiMemberVO 상태로 ArrayList 에 저장	
	 public static void printlnCsiMemberVO(CsiMemberVO cvo) {
		 
		System.out.println("Cnum 		: " + cvo.getCnum());
		System.out.println("Cname 		: " + cvo.getCname());
		System.out.println("Cid			: " + cvo.getCid());
		System.out.println("Cpw 		: " + cvo.getCpw());
		System.out.println("Cbirth		: " + CodeUtil.birth(cvo.getCbirth()));
		System.out.println("Cgender 	: " + CodeUtil.gender(cvo.getCgender()));
		System.out.println("Ctel		: " + CodeUtil.tel(cvo.getCtel()));
		System.out.println("Chp			: " + CodeUtil.hp(cvo.getChp()));
		System.out.println("Cemail		: " + cvo.getCemail());
		System.out.println("Caddr		: " + cvo.getCaddr());
		System.out.println("Chobby		: " + CodeUtil.hobby(cvo.getChobby()));
		System.out.println("Cphoto		: " + cvo.getCphoto());
		System.out.println("Cskill		: " + cvo.getCskill());
		System.out.println("Cjob()		: " + CodeUtil.job(cvo.getCjob()));
		System.out.println("Deleteyn	: " + cvo.getDeleteyn());
		System.out.println("Insertdate	: " + cvo.getInsertdate());
		System.out.println("Insertdate	: " + cvo.getUpdatedate());
	}
}
