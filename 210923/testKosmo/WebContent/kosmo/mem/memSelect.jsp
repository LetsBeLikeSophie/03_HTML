...
<tr>
	<td>회원번호</td>
	<td><input type="text" name="mnum" id="mnum" value="<%= mvo.getMnum() %>" readonly /></td>
 </tr>
<tr>
	<td>이름</td>
...
<tr>
 ...
 <tr>
	<td>사진</td>
	<td> 
		<img src="/testKosmo/fileupload/member/<%= mvo.getMphoto() %> " border="1" width="25" height="25" alt="image">
    </td>
</tr>
<tr>
	<td colspan="2" align="center">	
